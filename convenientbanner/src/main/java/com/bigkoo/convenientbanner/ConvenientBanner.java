...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public enum PageIndicatorAlign {
        ALIGN_PARENT_LEFT, ALIGN_PARENT_RIGHT, CENTER_HORIZONTAL, CENTER_VERTICAL
    }
        ...
        public void run() {
            ...
            if (convenientBanner != null) {
                if (convenientBanner.viewPager != null && convenientBanner.turning) {
                    ...
                    mHandler.postDelayed(convenientBanner.adSwitchTask, convenientBanner.autoTurningTime);
                }
            }
        }
    }
    ...
    public ConvenientBanner startTurning(long autoTurningTime) {
        ...
        turning = true;
        mHandler.postDelayed(adSwitchTask, autoTurningTime);
        return this;
    }
    ...
    public CBPageChangeListener getPageChangeListener() {
