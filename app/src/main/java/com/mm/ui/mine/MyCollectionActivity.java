 ...
 * Update Remark：
 */
public class MyCollectionActivity extends BaseMvpActivity<FindListPresenter> implements IFindListView {
    /**
     * 返回
     */
    ...
    protected void initUI() {
        ...
        mAdapter.setOnItemViewClickListener(new AbstractRecyclerViewAdapter.OnItemViewClickListener() {
            ...
            public void onViewClick(View view, int position) {
                ...
                JumpUtil.overlay(MyCollectionActivity.this, FindDetailActivity.class, bundle);
            }
        });
