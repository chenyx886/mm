...
import com.mm.R;
import com.mm.ui.mine.MoreAddressActivity;
import com.mm.ulits.MediaUtils;
import com.mm.widget.SendView;
import com.mm.widget.VideoProgressBar;
...
//        view = (TextView) findViewById(R.id.view);
    ...
    private View.OnClickListener selectClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            path = mediaUtils.getTargetFilePath();
            send.stopAnim();
            recordLayout.setVisibility(View.VISIBLE);
            Bundle bundle = new Bundle();
            bundle.putString("path", path);
            JumpUtil.overlay(VideoRecorderActivity.this, AddFindVideoActivity.class, bundle);
            finish();
        }
    };
